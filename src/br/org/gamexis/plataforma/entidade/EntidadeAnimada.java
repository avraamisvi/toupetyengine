...
public abstract class EntidadeAnimada extends Entidade implements
	...
	public boolean isFaceDireita() {
		return face == AtorFaceOrientacao.direita || isFaceDireitaAbaixo() || isFaceDireitaAcima();
	}
	
	public boolean isFaceEsquerda(){
		return face == AtorFaceOrientacao.esquerda || isFaceEsquerdaAbaixo() || isFaceDireitaAcima();
	}
