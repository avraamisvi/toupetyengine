...
public class Imagem implements Desenho {
	...
	float x;
	float y;
	float fatorTamanhoX = 1;
	float fatorTamanhoY = 1;
	...
	public void desenhar(Graphics g) {
		...
		desenhar(g, fatorTamanhoX, fatorTamanhoY);
	}
	...
	public float getFatorTamanhoX() {
		return fatorTamanhoX;
	}

	public void setFatorTamanhoX(float fatorTamanhoX) {
		this.fatorTamanhoX = fatorTamanhoX;
	}

	public float getFatorTamanhoY() {
		return fatorTamanhoY;
	}

	public void setFatorTamanhoY(float fatorTamanhoY) {
		this.fatorTamanhoY = fatorTamanhoY;
	}
